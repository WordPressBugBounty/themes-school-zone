...
School Zone WordPress Theme, Copyright 2018 rarathemes.com
...
* Screenshot image: 
	- https://pxhere.com/en/photo/1383612
...
== Changelog ==
	...
	* Changed demo link
	...
	1.0.8
	* Fixed header navigation issue

	1.0.7
	* Fixed menu accessibility design issue
	* Changed default loreum ipsum text
	* Added static page content when all home page section is disabled

	1.0.6
	* Accessibility in menu for edge fixed.
